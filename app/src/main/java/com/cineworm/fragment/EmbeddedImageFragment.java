...
import com.cineworm.videostreamingapp.EmbeddedPlayerActivity;
import com.cineworm.videostreamingapp.R;
import com.cineworm.videostreamingapp.VimeoPlayerActivity;
import com.cineworm.videostreamingapp.YtPlayerActivity;
            ...
            public void onClick(View v) {
                if (!streamUrl.isEmpty()) {
                    if (PlayerUtil.isYoutubeUrl(streamUrl)) {
                        Intent intent = new Intent(getActivity(), YtPlayerActivity.class);
