...
public class HomeContentMoreFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int spanCountMovie = getResources().getInteger(R.integer.movieColumn);
        int spanCountShow = getResources().getInteger(R.integer.showColumn);
        layoutManager = new GridLayoutManager(getContext(), Type.equals("Movie") ? spanCountMovie : spanCountShow);
