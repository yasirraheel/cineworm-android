...
import com.cineworm.adapter.ShowAdapter;
...
public class ShowFragment extends Fragment {
    ...
    private void getShow() {
        ...
        if (filterData.isEmpty()) {
            ...
            FilterUtil.jsonForParameter(FilterUtil.jsonToSelectList(filterData), jsObj, FilterType.SHOW);
        }
        params.put("data", API.toBase64(jsObj.toString()));
        params.put("page", pageIndex);
        client.post(Constant.SHOW_FILTER_URL, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                if (isFirst)
        ...
        menuHost.addMenuProvider(new MenuProvider() {
            ...
            public boolean onMenuItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.menu_filter) {
                    ...
                    args.putInt("filterTypeSec", FilterType.SHOW);
