...
import com.cineworm.adapter.SportAdapter;
...
public class SportFragment extends Fragment {
    ...
    private void getSport() {
        ...
        if (filterData.isEmpty()) {
            ...
            FilterUtil.jsonForParameter(FilterUtil.jsonToSelectList(filterData), jsObj, FilterType.SPORT);
        }
        Log.e("jsObj", "" + jsObj);
        params.put("data", API.toBase64(jsObj.toString()));
        params.put("page", pageIndex);
        client.post(Constant.SPORT_FILTER_URL, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                if (isFirst)
        ...
        menuHost.addMenuProvider(new MenuProvider() {
            ...
            public boolean onMenuItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.menu_filter) {
                    ...
                    args.putInt("filterTypeSec", FilterType.SPORT);
