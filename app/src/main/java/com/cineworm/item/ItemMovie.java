...
public class ItemMovie {
    ...
    public String getMovieShareLink() {
        return movieShareLink;
    }

    public void setMovieShareLink(String movieShareLink) {
        this.movieShareLink = movieShareLink;
    }
    ...
    public void setMovieContentRating(String movieContentRating) {
        this.movieContentRating = movieContentRating;
    }
