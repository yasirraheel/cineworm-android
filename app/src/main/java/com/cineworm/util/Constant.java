...
import com.cineworm.videostreamingapp.BuildConfig;
...
public class Constant implements Serializable {
    ...
    public static final String DEVICE_LIST_URL = API_URL + "user_active_device_list";
    public static final String DEVICE_LOGOUT_REMOTE_URL = API_URL + "logout_user_remotely";
    ...
    public static final String COIN_GATE_PAYMENT_URL = API_URL + "coingate_pay";
    public static final String COIN_GATE_PAYMENT_STATUS_URL = API_URL + "coingate_payment_status";
    public static final String PAYSTACK_TOKEN_URL = API_URL + "paystack_token_get";
    public static final String MOLLIE_PAYMENT_URL = API_URL + "mollie_pay";
    public static final String MOLLIE_PAYMENT_STATUS_URL = API_URL + "mollie_payment_status";
    public static final String DELETE_USER_URL = API_URL + "account_delete";
    public static final String FILTER_LIST_URL = API_URL + "lang_genre_cat_list";
    public static final String MOVIE_FILTER_URL = API_URL + "movies_filter";
    public static final String SHOW_FILTER_URL = API_URL + "shows_filter";
    public static final String SPORT_FILTER_URL = API_URL + "sports_filter";
    public static final String TV_FILTER_URL = API_URL + "livetv_filter";
    ...
    public static final String TV_URL_2 = "tv_url2";
    public static final String TV_URL_3 = "tv_url3";
    ...
    public static final String BANK_TRANSFER_INFO = "banktransfer_info";
    public static final String CP_API_KEY = "cinetpay_api_key";
    public static final String CP_SITE_ID = "cinetpay_site_id";
    public static final String SL_STORE_ID = "store_id";
    public static final String SL_STORE_PASSWORD = "store_password";
    ...
    public static final String VIDEO_TYPE_EMBED = "Embed";
    ...
    public static boolean isBanner = false, isInterstitial = false, isPlayerAd = false;
    ...
    public static String bannerId, interstitialId, appIdOrPublisherId, playerAdVastUrl = "";
