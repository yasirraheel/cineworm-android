...
public class CashFreeActivity extends AppCompatActivity implements CFCheckoutResponseCallback {
    ...
    String planId, planPrice, planCurrency, planGateway, planGateWayText, cashFreeAppId, planName, couponCode, couponPercentage;
    Button btnPay;
    MyApplication myApplication;
    boolean isSandbox = false;
    String orderId = "", paymentSessionID = "";
                ...
                try {
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        if (objJson.getString("success").equals("1")) {
                            paymentSessionID = objJson.getString("payment_session_id");
    ...
    public void onPaymentVerify(String orderID) {
        if (NetworkUtils.isConnected(CashFreeActivity.this)) {
            new Transaction(CashFreeActivity.this)
                    .purchasedItem(planId, orderID, planGateway, couponCode, couponPercentage);
        } else {
