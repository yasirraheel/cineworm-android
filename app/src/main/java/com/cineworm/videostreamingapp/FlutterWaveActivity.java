...
public class FlutterWaveActivity extends AppCompatActivity {
    ...
    String planId, planPrice, planCurrency, planGateway, planGateWayText, fwPublicKey, fwEncryptionKey, planName,couponCode, couponPercentage;
    Button btnPay;
                    ...
                    if (status.equals("successful")) {
                        if (NetworkUtils.isConnected(FlutterWaveActivity.this)) {
                            new Transaction(FlutterWaveActivity.this)
                                    .purchasedItem(planId, jsonData.getString("flwRef"), planGateway, couponCode, couponPercentage);
                        }
                    } else {
