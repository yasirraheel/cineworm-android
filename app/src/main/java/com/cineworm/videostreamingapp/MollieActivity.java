...
public class MollieActivity extends AppCompatActivity {
    ...
    String molliePaymentId, paymentUrl;
    ...
    private void getPaymentUrl() {
        ...
        client.post(Constant.MOLLIE_PAYMENT_URL, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                ...
                try {
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        if (objJson.getString("success").equals("1")) {
                            molliePaymentId = objJson.getString("mollie_payment_id");
    ...
    private void getPaymentStatus() {
        ...
        RequestParams params = new RequestParams();
        JsonObject jsObj = (JsonObject) new Gson().toJsonTree(new API());
        jsObj.addProperty("mollie_payment_id", molliePaymentId);
        params.put("data", API.toBase64(jsObj.toString()));
        client.post(Constant.MOLLIE_PAYMENT_STATUS_URL, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                progressBar.setVisibility(View.VISIBLE);
                ...
                try {
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        if (objJson.getString("success").equals("1")) {
                            ...
                            new Transaction(MollieActivity.this)
    ...
    private void showError(String Title) {
        new AlertDialog.Builder(MollieActivity.this)
