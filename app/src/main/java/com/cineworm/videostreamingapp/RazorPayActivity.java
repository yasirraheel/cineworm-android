...
public class RazorPayActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    String planId, planPrice, planCurrency, planGateway, planGateWayText, razorPayKey, planName,couponCode, couponPercentage;
    Button btnPay;
        ...
        try {
            if (NetworkUtils.isConnected(RazorPayActivity.this)) {
                new Transaction(RazorPayActivity.this)
                        .purchasedItem(planId, razorpayPaymentID, planGateway, couponCode, couponPercentage);
            } else {
