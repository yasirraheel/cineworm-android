...
import com.cineworm.adapter.HomeTVAdapter;
...
public class SearchHorizontalActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvMovie.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 1));
        rvMovie.setFocusable(false);
        rvMovie.setNestedScrollingEnabled(false);

        rvShow.setHasFixedSize(true);
        rvShow.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 2));
        rvShow.setFocusable(false);
        rvShow.setNestedScrollingEnabled(false);

        rvSport.setHasFixedSize(true);
        rvSport.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 2));
        rvSport.setFocusable(false);
        rvSport.setNestedScrollingEnabled(false);


        rvTV.setHasFixedSize(true);
        rvTV.setLayoutManager(new LinearLayoutPagerManager(SearchHorizontalActivity.this, LinearLayoutManager.HORIZONTAL, false, 2));
    ...
    private void displayData() {
        ...
        if (!showList.isEmpty()) {
            showAdapter = new HomeShowAdapter(SearchHorizontalActivity.this, showList);
