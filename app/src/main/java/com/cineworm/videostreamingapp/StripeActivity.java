...
public class StripeActivity extends AppCompatActivity {
    ...
    String planId, planPrice, planCurrency, planGateway, planGateWayText, stripePublisherKey, couponCode, couponPercentage;
    Button btnPay;
...
//            Log.e("App", "Got error: ", ((PaymentSheetResult.Failed) paymentSheetResult).getError());
            ...
            if (NetworkUtils.isConnected(StripeActivity.this)) {
                new Transaction(StripeActivity.this)
                        .purchasedItem(planId, paymentIntentId, planGateway, couponCode, couponPercentage);
            } else {
