...
public class TVDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("TVDetails", "Failed to initialize Cast: " + e.getMessage());
            e.printStackTrace();
            mediaRouteButton = findViewById(R.id.media_route_button);
        ...
        rvRelated.setLayoutManager(new LinearLayoutPagerManager(TVDetailsActivity.this, LinearLayoutManager.HORIZONTAL, false, 2));
    ...
    private void displayData() {
        ...
        String text = "<html dir=" + direction + "><head>" + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/fonts/custom.otf\")}body{font-family: MyFont;color: #9c9c9c;font-size:14px;margin-left:0px;line-height:1.3}" + "</style></head>" + "<body>" + htmlText + "</body></html>";
            ...
            switch (itemTV.getTvType()) { //URL Embed
                case Constant.VIDEO_TYPE_HLS:
                    if (casty != null && casty.isConnected()) {
                        ...
                        ExoPlayerFragment exoPlayerFragment = ExoPlayerFragment.newInstance(getPlayerData(streamUrl));
...
//        toolbar.setVisibility(View.GONE);
    ...
    private ItemPlayer getPlayerData(String streamUrl) {
        ItemPlayer itemPlayer = new ItemPlayer();
        itemPlayer.setDefaultUrl(streamUrl);
